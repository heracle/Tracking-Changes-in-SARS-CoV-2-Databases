...
AccIdTnode::AccIdTnode(const uint64_t rc_data_id, const uint64_t rc_prio, const uint64_t rc_index_tnode = 0xffffffff)
    : Tnode(rc_data_id, rc_prio, rc_index_tnode) {}

AccIdTnode::AccIdTnode(const uint64_t index) : Tnode(index) {}

void AccIdTnode::reset_get_h5_tnode(const H5::Group &) {}

Tnode* AccIdTnode::get_h5_tnode(const uint64_t req_data_id, const unsigned long long req_prio, const uint64_t req_index) {
...
Tnode* AccIdTnode::create_new_specialized_tnode(const uint64_t data_id) {
