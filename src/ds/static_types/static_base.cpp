...
BaseSortedTreap::BaseSortedTreap(const std::string &req_key, const uint64_t req_database_id) {
    this->key = req_key;
...
BaseSortedTreap::BaseSortedTreap(const H5::Group &h5_group) {
    ...
    this->database_id = H5Helper::get_uint64_attr_from(h5_group, "database_id");
}
