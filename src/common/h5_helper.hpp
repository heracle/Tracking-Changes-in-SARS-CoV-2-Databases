...
// void write_to_hdf5_dataset(const uint32_t elem_size, const uint32_t positions[], const std::string &str_to_save, H5::Group *h5, const std::string &dataset_name);
// void read_hdf5_dataset(const H5::Group &h5, const std::string &attr_name, uint32_t *elem_size, uint32_t positions[], std::string *loaded_str);
